...
function Contactcompo1() {
    const handleSubmit = () => {
        // Show an alert confirming feedback submission
        alert('Your feedback is submitted!');
        // Assuming you want to redirect after submission, you still need to do it using BrowserRouter in your App.js or where the routing is defined
    };
    ...
    return (
        ...
        <div  className="container mx-auto pt-16">
            <div className="lg:flex">
                <div className="xl:w-2/5 lg:w-2/5 bg-indigo-900 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div  className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        <h1 className="xl:text-4xl text-3xl pb-4 text-white font-bold">Get in touch</h1>
                        <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">Have questions about us? Interested in partnering with us? Have suggestions or just want to say hi? Feel free to contact us. We're here to assist you.</p>
                        <div className="flex pb-4 items-center">
                            ...
                            <p className="pl-4 text-white text-base">+91 5634489638</p>
                        </div>
                        <div className="flex items-center">
                            ...
                            <p className="pl-4 text-white text-base">info@festivenest.com</p>
                        </div>
                ...
                <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                    <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                        <h1 className="text-4xl text-gray-800 font-extrabold mb-6">Your Feedback!</h1>
                        ...
                        <div className="w-full mt-6">
                            ...
                            <button onClick={handleSubmit} type="submit" className="focus:outline-none bg-indigo-900 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6">
                                Submit
                            </button>
                        </div>
                    </form>
