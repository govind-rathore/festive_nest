        ...
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
            ...
            <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
                <div className=" md:w-5/12 lg:w-4/12 w-full ">
                    <img src="./images/party1.jpg" alt="Img of Glass bottle" className="w-full md:block hidden" />
                ...
                <div className=" md:w-7/12 lg:w-8/12 w-full md:mt-0 sm:mt-14 mt-10">
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-gray-800">Explore Events</h3>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show ? "block" : "hidden")}>Discover a world of exciting events near you! From concerts and workshops to festivals and fundraisers, find your next memorable experience with ease.</p>
                    </div>
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-gray-800">List Your Event</h3>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show2 ? "block" : "hidden")}>Showcase your event to a broader audience by listing it on Festive Nest. Our user-friendly platform makes event promotion simple and effective.</p>
                    </div>
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-gray-800">Event Planning Resources</h3>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show3 ? "block" : "hidden")}>Access a wealth of resources to streamline your event planning process. From budgeting tools to venue selection guides, we've got you covered every step of the way.</p>
                    </div>
                    ...
                    <div>
                        <div className=" flex justify-between items-center cursor-pointer">
                            <h3 className=" font-semibold text-xl leading-5 text-gray-800">Effortless QR Code Generation</h3>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show4 ? "blcok" : "hidden")}>Our QR code generator tool simplifies the process of creating QR codes for your business or personal use. With just a few clicks, generate custom QR codes tailored to your specific needs, whether it's for marketing materials, event tickets, or product packaging.</p>
                    </div>
