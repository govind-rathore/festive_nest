                ...
                <div className="container mx-auto py-12">
                    <div className="xl:flex lg:flex md:flex pt-6">
                        <div className="w-11/12 xl:w-3/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0">
                            <div className="flex items-center mb-6 xl:mb-0 lg:mb-0">
                                ...
                                <p className="ml-3 font-bold text-xl">FESTIVEnest.com</p>
                            </div>
                        </div>
                        <div className="w-11/12 xl:w-1/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end pl-3 sm:pl-0">
                            <ul>
                                <li className="text-gray-800 font-bold text-xl mb-6">Product</li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="qr">QR Code Generator</a>
                                </li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="volap">Volunteership opportunity </a>
                                </li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="td">Tickets Designing</a>
                                </li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="javascript:void(0)">Platform for vitual event</a>
                                </li>
                            </ul>
                        </div>
                        <div className="w-11/12 xl:w-1/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end pl-3 sm:pl-0">
                            <ul>
                                ...
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="javascript:void(0)">Find event location</a>
                                </li>
                        ...
                        <div className="w-11/12 xl:w-1/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end pl-3 sm:pl-0">
                            <ul>
                                <li className="text-gray-800 font-bold text-xl mb-6">Company</li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="abu">About Us</a>
                                </li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="cup">Contact us</a>
                                </li>
                                <li className="text-base text-gray-600 hover:text-gray-700 mb-5">
                                    <a href="cup">Feedback</a>
                                </li>
                    ...
                    <div className="xl:flex flex-wrap justify-between xl:mt-24 mt-16 pb-6 pl-3 sm:pl-0">
                        <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
                            <p className="text-gray-800 text-base">2024 FESTIVEnest.com All Rights Reserved</p>
                        </div>
