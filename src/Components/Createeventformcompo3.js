import Modalcreteven from "./Modalcreteven";
  ...
  function Createeventformcompo3() {
    ...
    return (
        ...
        <div className="mt-10 border border-gray-300 rounded">
          <div className="flex flex-wrap items-center px-4 py-3 border-b border-gray-300">
            ...
            <div className="flex items-center justify-end ml-2 gap-x-3 lg:ml-auto md:ml-auto">
              <a  onClick={() => handleLoginRedirect('/upload file')} className="flex items-center gap-x-1 text-sm leading-none text-gray-600 cursor-pointer">
                Add Image
                <svg
                  width={20}
                  height={20}
        ...
        <p className="mt-3 text-xs leading-[15px] text-gray-600 px-7">
          Enter event description for better understanding
        </p>
        <div className="flex flex-col flex-wrap items-center justify-center w-full px-7 lg:flex-row lg:justify-end md:justify-end gap-x-4 gap-y-4">
                  <button onClick={() => handleLoginRedirect('/')} className="bg-white border-indigo-700 rounded hover:bg-gray-50 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-indigo-700 border lg:max-w-[95px]  w-full ">
                    Cancel
                  </button>
                  <button onClick={() => handleLoginRedirect('/dashboardllink')} className="bg-indigo-700 rounded hover:bg-indigo-600 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white lg:max-w-[144px] w-full ">
                    Create Event
                  </button>
                </div>
      </div>
...
export default Createeventformcompo3;
